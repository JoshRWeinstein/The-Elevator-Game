class RidesController < ApplicationController
  ...
  def results
    ...
    @lobby0top = Ride.find(:all, :conditions => "config = 0 and floor = 1 and top = true").count
    @lobby0notnull = Ride.find(:all, :conditions => "top IS NOT NULL and config = 0").count
    ...
    @lobby2notnull = Ride.find(:all, :conditions => "top IS NOT NULL and config = 2").count
